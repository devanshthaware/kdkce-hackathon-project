...
const columns = [
  ...
  { 
    header: "Plan", 
    accessor: (item: any) => (
      <span className={`font-medium ${item.plan === "Enterprise" ? "text-emerald-400" : item.plan === "Pro" ? "text-blue-400" : "text-slate-400"}`}>
        {item.plan}
      </span>
    )
  },
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-400 mt-1">Manage platform developers and their access levels.</p>
        </div>
